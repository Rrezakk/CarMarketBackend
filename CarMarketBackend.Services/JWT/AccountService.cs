...
using CarMarketBackend.Domain.Api.Account;
using CarMarketBackend.Domain.Enums;
using CarMarketBackend.Domain.Exceptions;
...
namespace CarMarketBackend.Services.JWT;
...
public class AccountService : IAccountService
{
    ...
    public AuthenticateResponse RefreshToken(string token, string ipAddress)
    {
        ...
        if (refreshToken.IsRevoked)
        {
            ...
            AccountService.RevokeDescendantRefreshTokens(refreshToken, account, ipAddress, $"Attempted reuse of revoked ancestor token: {token}");
            _context.Update(account);
            _context.SaveChanges();
        }
    ...
    public void RevokeToken(string token, string ipAddress)
    {
        ...
        AccountService.RevokeRefreshToken(refreshToken, ipAddress, "Revoked without replacement");
        _context.Update(account);
        _context.SaveChanges();
    }
    ...
    private RefreshToken RotateRefreshToken(RefreshToken refreshToken, string ipAddress)
    {
        ...
        AccountService.RevokeRefreshToken(refreshToken, ipAddress, "Replaced by new token", newRefreshToken.Token);
    ...
    private static void RevokeDescendantRefreshTokens(RefreshToken refreshToken, Account account, string ipAddress, string reason)
    {
        ...
        if (!string.IsNullOrEmpty(refreshToken.ReplacedByToken))
        {
            ...
            if (childToken.IsActive)
                AccountService.RevokeRefreshToken(childToken, ipAddress, reason);
            else
                AccountService.RevokeDescendantRefreshTokens(childToken, account, ipAddress, reason);
        }
    }
